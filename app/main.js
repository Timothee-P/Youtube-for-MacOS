...
app.on('ready', () => {
    const cookieWide = { url: 'https://www.youtube.com', name: 'wide', value: '1' }
    const cookieBlack = { url: 'https://www.youtube.com', name: 'PREF', value: 'f1=50000000&f4=4000000&f6=400' }
    const cookieConsent = { url: 'https://www.youtube.com', name: 'CONSENT', value: 'YES+V10' }
    ...
    session.defaultSession.webRequest.onBeforeRequest(['*://*./*'], function (details, callback) {
        ...
        var check_white_list = /status|ssl.gstatic.com|www.gstatic.com|accounts.google.com|apis.google.com|premoa.*.jpg|index|www.youtube.com|googlevideo.com|rakuten|nitori-net|search\?tbs\=sbi\:|google.*\/search|ebay.*static.*g|\/shopping\/product|aclk?|translate.googleapis.com|encrypted-|product|www.googleadservices.com\/pagead\/aclk|target.com|.css/gi;
...
ipcMain.on('asynchronous-message', (event, arg, arg1) => {
    if (arg == 'showButton') {
        ...
        mainWindow.setBounds({ x: 50, y: 50, width: 550, height: Math.floor(arg1) })
        app.dock.show();
